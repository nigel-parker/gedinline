...
// JULY 2011: incorporated changes from http://www.heiner-eichmann.de/gedcom/charintr.htm
...
public class AnselInputStreamReader extends InputStreamReader {
    ...
    private int convert1(int ansel) {
        switch (ansel) {
            ...
            case 0xAE:
                return 0x02BC;  //  modifier letter apostrophe
            case 0xB0:
                return 0x02BB;  //  modifier letter turned comma
            case 0xB1:
