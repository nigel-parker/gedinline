...
```
java -jar build/libs/gedinline-3.0.3-beta.jar build/resources/test/gedcom-files/harvey-70.ged
```

To save the result, redirect the output to a file:

```
java -jar build/libs/gedinline-3.0.3-beta.jar build/resources/test/gedcom-files/harvey-70.ged > report.txt
```
...
```
build/libs/gedinline-3.0.3-beta.jar
```
